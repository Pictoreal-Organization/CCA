...
//               // Enhanced Tab Section with better segregation
//               Expanded(
//                 child: Container(
...
//                   child: Column(
//                     children: [
//                       // Custom Tab Bar with distinct styling
//                       Container(
...
//                                       Icons.event,
//                                       size: 20,
//                                       color: _currentTabIndex == 0 ? Colors.white : Colors.orange[600],
//                                     ),
//                                     SizedBox(width: 8),
//                                     Text(
//                                       'Meetings',
...
//                                       Icons.task_alt,
//                                       size: 20,
//                                       color: _currentTabIndex == 1 ? Colors.white : Colors.green[600],
//                                     ),
//                                     SizedBox(width: 8),
//                                     Text(
//                                       'Tasks',
...
//               ),
//               Spacer(),
//               if (!isLoadingMeetings && meetings.isNotEmpty)
//                 Container(
...
//           ),
//           const SizedBox(height: 20),
//           Expanded(child: _buildMeetingsSection()),
//         ],
//       ),
//     );
//   }
...
//                   borderRadius: BorderRadius.circular(12),
//                 ),
//                 child: Icon(Icons.task_alt, color: Colors.green[600], size: 24),
//               ),
//               const SizedBox(width: 12),
//               Expanded(
//                 child: Text(
...
//               ),
//               Spacer(),
//               if (!isLoadingTasks && tasks.isNotEmpty)
//                 Container(
//                   padding: EdgeInsets.symmetric(horizontal: 12, vertical: 6),
//                   decoration: BoxDecoration(
...
//                   ),
//                   child: Text(
//                     '${tasks.where((task) => task.status.toLowerCase() != 'completed').length} pending',
//                     style: TextStyle(
//                       fontSize: 12,
//                       fontWeight: FontWeight.w600,
//                       color: Colors.green[700],
...
//         return AnimatedContainer(
//           duration: Duration(milliseconds: 300 + (index * 100)),
//           child: _buildMeetingCard(meetings[index]),
//         );
//       },
//     );
//   }
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
            ...
            body: TabBarView(
              ...
              children: [
                Container(
                  ...
                  child: _buildMeetingsSectionScrollable(),
                ),
                Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                  ...
                  child: _buildTasksSectionScrollable(),
                ),
              ],
            ),
          ),
  ...
  Widget _buildMeetingsSectionScrollable() {
    if (isLoadingMeetings) {
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
  ...
  Widget _buildTasksSectionScrollable() {
    if (isLoadingTasks) {
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
...
// Sticky TabBar delegate to keep it pinned at the top during scroll
