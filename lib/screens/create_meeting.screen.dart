...
class _CreateMeetingScreenState extends State<CreateMeetingScreen>
  ...
  void _showStatusDialog({
    ...
    showDialog(
      context: context,
      barrierDismissible:
          !isError, // Force user to click OK on errors if desired
  ...
  // ✅ Updated Member Selector to clear quick select when manually adding
  Widget _buildMemberSelector() {
    TextEditingController? memberController;
                        ...
                        onTap: () {
                          setState(() {
                            if (selected) {
                              ...
                              invitedUserIds.add(user['_id']);
                              selectedQuickOption =
                                  null; // Clear quick select when manually adding
                            }
                          });
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            quickSelectOptions.firstWhere(
                              (opt) => opt['id'] == selectedQuickOption,
                            )['label'],
                            style: const TextStyle(
                              color: AppColors.green,
                              fontSize: 10,
