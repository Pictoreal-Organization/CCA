...
//   List<String> allTags = ['General', 'Design', 'Tech', 'Management', 'Event'];
...
//               // Meeting type
//               Text('Meeting Type', style: const TextStyle(fontWeight: FontWeight.bold)),
//               Row(
//                 children: [
//                   Radio<String>(
//                     value: 'offline',
...
//               // Conditional fields for offline/online
...
//               Text('Meeting Visibility', style: const TextStyle(fontWeight: FontWeight.bold)),
//               Row(
//                 children: [
//                   Radio<bool>(
//                     value: false,
