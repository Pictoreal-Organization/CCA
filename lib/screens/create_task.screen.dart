  ...
  void submit() async {
    if (subtasks.isEmpty) {
      ...
      _showStatusDialog(
        ...
        message: "Please create at least one subtask to proceed.",
        isError: true,
      );
      return;
    }
    if (!_formKey.currentState!.validate()) {
      ...
      _showStatusDialog(
        ...
        message: "Please fill in all required fields marked with errors.",
        isError: true,
      );
      return;
    }
    if (deadline == null) {
      ...
      _showStatusDialog(
        title: "No Deadline",
        message: "Please pick a deadline for this task.",
        isError: true,
      );
      return;
    }
    if (taskScope == 'team-specific' && selectedTeamIds.isEmpty) {
      ...
      _showStatusDialog(
        ...
        message: "You selected 'Team-Specific' but didn't pick any teams.",
        isError: true,
      );
      return;
    }
