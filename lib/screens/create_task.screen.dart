...
//         content: Text('Please select at least one team for a team-specific task.'),
...
//                     decoration: _buildInputDecoration('Task Title', Icons.title_rounded),
...
//                     decoration: _buildInputDecoration('Description (Optional)', Icons.description_outlined),
//                     maxLines: 2,
...
//                 options: const [
//                   ToggleOption(value: 'general', label: 'General', icon: Icons.public),
//                   ToggleOption(value: 'team-specific', label: 'Team-Specific', icon: Icons.group),
//                 ],
//                 selected: taskScope,
                        ...
                        onTap: () async {
                          final selected = await showDialog<List<String>>(
                            ...
                            builder: (context) {
                              ...
                              return StatefulBuilder(
                                builder: (context, setDialogState) {
                                  // ✅ Updated filter: search by name and rollNo
                                  final filteredUsers = allUsers
                                      .where((user) {
                                        final name = user['name'] ?? '';
                                        final rollNo = user['rollNo'] ?? '';
                                        final searchText = "$name $rollNo".toLowerCase();
                                  ...
                                  return AlertDialog(
                                    ...
                                    content: isUsersLoading
                                        ...
                                        : Column(
                                            mainAxisSize: MainAxisSize.min,
                                            children: [
                                              // ✅ Search field with updated hint
                                              TextField(
                                                decoration: InputDecoration(
                                                ...
                                                child: ListView(
                                                  children: filteredUsers.map((user) {
                                                    ...
                                                    return CheckboxListTile(
                                                      ...
                                                      // ✅ Display roll number as subtitle
                                                      subtitle: Text(
                                                        "Roll No: $rollNo",
                                                        style: const TextStyle(
                                                          color: AppColors.lightGray,
